package com.example.xiaohua.bestweather.activity;
...
import com.example.xiaohua.bestweather.R;
import com.example.xiaohua.bestweather.util.HttpCallbackListener;
import com.example.xiaohua.bestweather.util.HttpUtil;
import com.example.xiaohua.bestweather.util.Utility;
...
/*
    你应该确定好R所在的package。检查你AndroidManifest.xml中<manifest >
    节点中的package元素的值，比如package="com.test.demo"；那么在你的代码中，
    应该 import com.test.demo.R ；另外可能是res目录下一些layout或者其他资源文档有问题，
    导致R无法正常生成，所以找不到
*/
